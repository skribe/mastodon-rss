...
class mastodon_rss_widget extends WP_Widget {
    ...
    public function widget( $args, $instance ) 
    {
        ...
        // I have no idea why I have to use a function instead of just placing
        // 600 in the add_filter.  I tried.  Didn't work.
        ...
        {
            // Fetches the feed and caches it <_-- caching is important...apparently
                ...
                if (strcmp($gen, 'Mastodon') == 0)
                {
                    ...
                    else 
                    {
                        foreach ($items as $item)
                        {
                            ...
                            echo __( '<p class = "mastodon-rss-pubdate">' . esc_html(strip_tags(get_date_from_gmt($item->get_date('Y-m-d H:i:s'), 'j F Y @ g:i a' ))) . '</p>', 'mastodon_rss_widget_domain' );
